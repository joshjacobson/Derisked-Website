...
As a result, I believe the highest priority actions to potentially take regarding smoke detectors, ranked, are:
...
<div class="custom_pdf_container"><iframe class="custom_pdf" src="http://docs.google.com/gview?url=http://derisked.org/assets/Smoke%20Detector%20Comparison.pdf&embedded=true" frameborder="0" style="position: absolute; left:0; width: 100%; height: 100%; background: none;"></iframe></div>
...
{% maincolumn "" "If you click a link, and a dialogue box appears that runs offscreen, press 'return' or 'enter' to cause the link to open. Press 'escape' to close the dialogue." %}
<!-- Image Map Generated by http://www.image-map.net/ 
<img src="Smoke Detector Comparison Img.001.jpeg" usemap="#image-map">

<map name="image-map">
<a href="example.com" title="" style="position: absolute; left: 3.12%; top: 32.55%; width: 10.93%; height: 2.63%; z-index: 2;"></a><a href="test.org" title="" style="position: absolute; left: 2.91%; top: 53.34%; width: 13.78%; height: 3.39%; z-index: 2;"></a>
</map>-->
